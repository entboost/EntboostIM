...
public class AbAppUtil {
	...
	/** The tag. */
	private static String TAG = AbAppUtil.class.getSimpleName();
	private static String LONG_TAG = AbAppUtil.class.getName();	
	...
	public static void logD(String tag, String msg) {
		...
		Log4jLog.d(tag, msg+":"+(endLogTimeInMillis-AbAppData.startLogTimeInMillis)+"ms");
	}
