	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			if (isComMsg) {
				...
				viewHolder.errMsg = (TextView) convertView
						.findViewById(R.id.errMsg);
				...
				viewHolder.file_offline_btn = (Button) convertView
						.findViewById(R.id.file_offline_btn);
			} else {
				convertView = mInflater.inflate(
				...
				viewHolder.file_refuse_btn = (Button) convertView
						.findViewById(R.id.file_refuse_btn);
				viewHolder.file_cancel_btn = (Button) convertView
						.findViewById(R.id.file_cancel_btn);
...
//							context.startActivity(intent);
		...
		if (isComMsg) {
			...
			if (img != null) {
				...
				ImageLoader.getInstance().displayImage(mChatMsg.getHeadUrl(),
						viewHolder.userHead,
						MyApplication.getInstance().getImgOptions());
			}
