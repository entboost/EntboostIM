...
public class RecordHelper implements OnCompletionListener, OnErrorListener {
	...
	public void startRecording(Context context) {
		...
		if (mSampleFile == null) {
			String fileName = SAMPLE_PREFIX + System.currentTimeMillis()
					+ ".amr";
//			mSampleFile = new File(FileCacheUtils.getChatVoicePath() + fileName);
//			FileUtils.createDirectory(FileCacheUtils.getChatVoicePath());
		}
