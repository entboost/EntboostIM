...
import com.entboost.ui.base.view.app.AbMonitorView;
import com.entboost.ui.base.view.titlebar.AbBottomBar;
...
public abstract class AbActivity extends FragmentActivity {
	...
	private static String LONG_TAG = AbActivity.class.getName();		
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 填入View
		LayoutParams layoutParamsTitleBar = new LinearLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, 90);
		ab_base.addView(mAbTitleBar, layoutParamsTitleBar);
		
		RelativeLayout.LayoutParams layoutParamsFW3 = new RelativeLayout.LayoutParams(
				ViewGroup.LayoutParams.FILL_PARENT,
				ViewGroup.LayoutParams.WRAP_CONTENT);
		layoutParamsFW3.addRule(RelativeLayout.BELOW, mAbTitleBar.getId());
		ab_base.addView(pageInfo, layoutParamsFW3);
		...
		RelativeLayout.LayoutParams layoutParamsFW1 = new RelativeLayout.LayoutParams(
				ViewGroup.LayoutParams.FILL_PARENT,
				ViewGroup.LayoutParams.WRAP_CONTENT);
		layoutParamsFW1.addRule(RelativeLayout.BELOW, pageInfo.getId());
		...
		abSharedPreferences = getSharedPreferences(AbConstant.SHAREPATH,
	...
	public void showDialog(int id, View view) {
		...
		if (id == AbConstant.DIALOGBOTTOM) {
			...
			Log4jLog.i(LONG_TAG, "Dialog的ID传错了，请参考AbConstant类定义");
		}
	}
	...
	protected Dialog onCreateDialog(int id) {
		...
		case AbConstant.DIALOGPROGRESS:
			if (mProgressDialog == null) {
				Log4jLog.i(LONG_TAG, "Dialog方法调用错误,请调用showProgressDialog()!");
			}
			return mProgressDialog;
		case AbConstant.DIALOGBOTTOM:
			if (mBottomDialog == null) {
				Log4jLog.i(LONG_TAG, "Dialog方法调用错误,请调用showDialog(int id,View view)!");
			}
